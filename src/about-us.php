...
<html>
    ...
    <head>
        ...
        <title>People behing project</title>
    </head>
                ...
                <ul class="creators-list">
                    ...
                    <a href="alberto-kerim.php">
                        <li class="creators-publish">
                            ...
                            <p class="creators-small-text">17 years old, 3. grade</p>
                        </li>
                    </a>

                    <a href="ivan-jerzabek.php">
                        <li class="creators-publish">
                            <img class="creators-picture" src="Pictures/jerza-head.JPG" height="20%" width="20%" >
                            <h3 class="creators-notice">Ivan Jeržabek</h3>
                            <p class="creators-small-text">18 years old, 4. grade</p>
                        </li>
                    </a>

                    <a href="nino-nogic.php">
                        <li class="creators-publish">
